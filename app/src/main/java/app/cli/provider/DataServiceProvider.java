...
import app.cli.data.AppEventData;
...
public final class DataServiceProvider implements ServiceProviderContract {
    ...
    public Map<Class<?>, Consumer<ContainerContract>> publishers() {
        return Map.of(
                ...
                CliRoutingDataContract.class, DataServiceProvider::publishCliRoutingData,
    ...
    public static void publishCliRoutingData(ContainerContract container) {
        container.setSingleton(CliRoutingDataContract.class, new AppCliRoutingData());
    }
